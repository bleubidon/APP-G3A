...
function lister_utilisateurs() {
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
            ...
            for (utilisateur in liste_utilisateurs) {
                ...
                innerHTML_string +=
                    ...
                    "<td><button class='button_like' type='button' onclick='supprimer_utilisateur(\"" + liste_utilisateurs[utilisateur]["identifiant"] + "\")'>Supprimer</button></td>";
    ...
    xmlhttp.open("POST", "../../views/admin/generer_table_utilisateurs.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
