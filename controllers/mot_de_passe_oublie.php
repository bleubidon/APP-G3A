...
if (isset($_POST['Mail'])) {
    ...
    if ($id_utilisateur != null) {  // L'adresse mail renseignée correspond à un utilisateur
        // Géné lien et page de récupération de mot de passe
        ...
        $sujet = "$prenom_utilisateur $nom_utilisateur, réinitialisez votre mot de passe sur Captimove !";
        ...
        réinitialiser votre mot de passe sur Captimove:<br>
