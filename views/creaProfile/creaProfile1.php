...
<section id="sec1_" class="section_centrale">
    ...
    <form action="" method="post" enctype="multipart/form-data" name="form1" onsubmit="return validationFormulaire()"
        ...
        <div id="name">
            <p><label for="Prenom" style="font-weight: bold">Prénom <abbr
                            title="Champ obligatoire; pas d'accents">*</abbr></label>
                <br>
        ...
        <br/>
        <div id="phone">
            <p><label for="dateNaissance" style="font-weight: bold">Date de Naissance <abbr
                            title="Champ obligatoire">*</abbr></label><br>
            ...
            &nbsp;
            &nbsp;
            <p><label for="numeroTel" style="font-weight: bold">Numéro de téléphone <abbr
                            title="Champ obligatoire">*</abbr></label><br>
        ...
        <div id="mail">
            ...
            <?php if (!isset($modification_profil)) { ?>
                <p><label for="identifiant" style="font-weight: bold">Identifiant <abbr
                                title="Champ obligatoire">*</abbr></label><br>
        ...
        <div id="mdp">
            ...
            &nbsp;
            &nbsp;
            <p><label for="validePassword " style="font-weight: bold">Confirmation du mot de
                    passe<?php echo isset($modification_profil) ?
                        " :" :
        ...
        <div id="photo">
            ...
            <input style="width: 100px" type="file" name="PhotoProfil" id="PhotoProfilId"
                   onchange="fichierSelectionne()"/> &nbsp;
